...
horrorGenre = FILTER genreRatingData by movieGenre == 'Horror';

groupByTitle =  GROUP horrorGenre by movieName;
averageRatingOfEachHorrorMovie = FOREACH groupByTitle GENERATE $0 as movieName, $1.movieGenre as movieGenre, AVG($1.rating) as averageMovieRating;


orderHorrorMoviesByRatingsDesc = ORDER averageRatingOfEachHorrorMovie by averageMovieRating DESC;
top10HorrorMovies = LIMIT orderHorrorMoviesByRatingsDesc 10;

STORE top10HorrorMovies into '/home/chetanchandak/Documents/Top10HorrorMovies' using PigStorage();
