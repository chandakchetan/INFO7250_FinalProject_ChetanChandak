...
actionGenre = FILTER genreRatingData by movieGenre == 'Action';

groupByTitle =  GROUP actionGenre by movieName;
averageRatingOfEachActionMovie = FOREACH groupByTitle GENERATE $0 as movieName, $1.movieGenre as movieGenre, AVG($1.rating) as averageMovieRating;
...
STORE top10ActionMovies into '/home/chetanchandak/Documents/Top10ActionMovies' using PigStorage();
