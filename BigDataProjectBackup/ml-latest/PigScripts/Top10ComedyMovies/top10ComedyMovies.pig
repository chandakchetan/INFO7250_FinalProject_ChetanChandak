...
comedyGenre = FILTER genreRatingData by movieGenre == 'Comedy';

groupByTitle =  GROUP comedyGenre by movieName;
averageRatingOfEachComedyMovie = FOREACH groupByTitle GENERATE $0 as movieName, $1.movieGenre as movieGenre, AVG($1.rating) as averageMovieRating;


orderComedyMoviesByRatingsDesc = ORDER averageRatingOfEachComedyMovie by averageMovieRating DESC;
top10ComedyMovies = LIMIT orderComedyMoviesByRatingsDesc 10;

STORE top10ComedyMovies into '/home/chetanchandak/Documents/Top10ComedyMovies' using PigStorage();
