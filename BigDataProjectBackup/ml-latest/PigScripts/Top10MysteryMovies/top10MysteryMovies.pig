...
mysteryGenre = FILTER genreRatingData by movieGenre == 'Mystery';

groupByTitle =  GROUP mysteryGenre by movieName;
averageRatingOfEachMysteryMovie = FOREACH groupByTitle GENERATE $0 as movieName, $1.movieGenre as movieGenre, AVG($1.rating) as averageMovieRating;


orderMysteryMoviesByRatingsDesc = ORDER averageRatingOfEachMysteryMovie by averageMovieRating DESC;
top10MysteryMovies = LIMIT orderMysteryMoviesByRatingsDesc 10;

STORE top10MysteryMovies into '/home/chetanchandak/Documents/Top10MysteryMovies' using PigStorage();
