...
WarGenre = FILTER genreRatingData by movieGenre == 'War';

groupByTitle =  GROUP WarGenre by movieName;
averageRatingOfEachWarMovie = FOREACH groupByTitle GENERATE $0 as movieName, $1.movieGenre as movieGenre, AVG($1.rating) as averageMovieRating;


orderWarMoviesByRatingsDesc = ORDER averageRatingOfEachWarMovie by averageMovieRating DESC;
top10WarMovies = LIMIT orderWarMoviesByRatingsDesc 10;

STORE top10WarMovies into '/home/chetanchandak/Documents/Top10WarMovies' using PigStorage();
