...
sciFiGenre = FILTER genreRatingData by movieGenre == 'Sci-Fi';

groupByTitle =  GROUP sciFiGenre by movieName;
averageRatingOfEachSciFiMovie = FOREACH groupByTitle GENERATE $0 as movieName, $1.movieGenre as movieGenre, AVG($1.rating) as averageMovieRating;


orderSciFiMoviesByRatingsDesc = ORDER averageRatingOfEachSciFiMovie by averageMovieRating DESC;
top10SciFiMovies = LIMIT orderSciFiMoviesByRatingsDesc 10;

STORE top10SciFiMovies into '/home/chetanchandak/Documents/Top10SciFiMovies' using PigStorage();
